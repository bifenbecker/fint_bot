...
Ceate Date: 2025-02-12 15:42:19.142103
...
down_revision: Union[str, None] = "56aae93eb433"
...
def upgrade() -> None:
    ...
    op.add_column(
        "cardbattle", sa.Column("status", cardbattlegamestatus, nullable=True)
    )
    ...
    op.add_column(
        "cardbattleturn", sa.Column("type", cardbattleturntype, nullable=False)
    )
    ...
    op.add_column(
        "player", sa.Column("card_battle_status", cardbattleplayerstatus, nullable=True)
    )
