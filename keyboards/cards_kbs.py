...
card_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(
                text="🎟 FINT Pass", callback_data="fintpass"),
        ],
        [
            InlineKeyboardButton(
...
my_collection_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="🃏 Просмотр карт", callback_data="mycards"),
        ],
        [
            InlineKeyboardButton(
                text="🗃 Просмотр паков", callback_data="mypacks"),
        ],
        [
            InlineKeyboardButton(
                text="🔄 Отсортировать дубликаты карт ", callback_data="recountduplicates"),
        ],
        [
            InlineKeyboardButton(
                text="⏪ Назад", callback_data="startplay")
...
filter_my_cards_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(
                text="🎴 По команде", callback_data="mycardsteams"),
        ],
        [
            InlineKeyboardButton(
                text="📋 Список карт", callback_data="list_my_cards"),
        ],
        [
            InlineKeyboardButton(
                text="⏪ Назад", callback_data="startplay")
...
def my_card_rarities_kb(rarities):
    ...
    for rarity in rarities:
        btns.append([InlineKeyboardButton(
            text=rarity, callback_data=f"rarity_{rarity}")])
...
def my_card_teams_kb(teams):
    ...
    for item in teams:
        btns.append([InlineKeyboardButton(
            text=item, callback_data=f"cteam_{item}")])
...
def my_team_cards_kb(page, last, sorting, team):
    ...
    btns.append([
        InlineKeyboardButton(text=txt, callback_data=f"sortmyteamcards_{sorting}_{team}")])
...
fintpass_back_kb = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="⏪ Назад", callback_data='startplay')]
])
