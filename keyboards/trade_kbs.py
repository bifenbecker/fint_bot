    ...
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="🔄 1 на 1 карту", callback_data=f"trdqnt_1")
        ],
        # [
        #     InlineKeyboardButton(
...
def trade_rarities_kb(rarities):
    ...
    for rarity in rarities:
        btns.append([InlineKeyboardButton(
            text=rarity, callback_data=f"trdrar_{rarity}")])
...
def card_mtrade_kb(page, last, sorting, status, rarity):
    ...
    if status == "in":
        btns.append([
            InlineKeyboardButton(
                text="➖", callback_data=f"trdunselecexcard_{page}")])
    else:
        btns.append([
            InlineKeyboardButton(
                text="➕", callback_data=f"trdselecexcard_{page}")])
    ...
    btns.append([
        InlineKeyboardButton(
            text="🃏 Выбор редкости", callback_data=f"mtrdrarities")])
...
def m_trade_rarities_kb(rarities):
    btns = [[InlineKeyboardButton(
            text="🃏 Все карты", callback_data=f"mtrdrar_all")]]
    for rarity in rarities:
        btns.append([InlineKeyboardButton(
            text=rarity, callback_data=f"mtrdrar_{rarity}")])
...
def target_card_mtrade_kb(page, last, sorting, status, rarity):
    ...
    if status == "in":
        ...
        btns.append([
            InlineKeyboardButton(
                text="➕", callback_data=f"anstrdselecexcard_{page}")])
...
def m_target_trade_rarities_kb(rarities):
    btns = [[InlineKeyboardButton(
            text="🃏 Все карты", callback_data=f"trgtmtrdrar_all")]]
    for rarity in rarities:
        btns.append([InlineKeyboardButton(
            text=rarity, callback_data=f"trgtmtrdrar_{rarity}")])
    btns.append([
        InlineKeyboardButton(
            text="❌Отклонить обмен", callback_data="cancel_trade")])
    return InlineKeyboardMarkup(inline_keyboard=btns)
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    ...
                    callback_data=f"confmtrade_{trade_id}")
            ],
            [
                InlineKeyboardButton(
                    text="❌ Отклонить обмен",
