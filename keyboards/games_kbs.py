...
games_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(
                text="⚖️ Битва паков", callback_data="packbattle"),
        ],
        [
            InlineKeyboardButton(
                text="🎯 Дартс", callback_data="darts"),
        ],
        [
            InlineKeyboardButton(
...
no_free_ls_btn = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="💵 Купить 3 удара", callback_data="buyls3"),
        ],
        [
            InlineKeyboardButton(
                text="💵 Купить 6 ударов", callback_data="buyls6"),
        ],
        [
            InlineKeyboardButton(
                text="💵 Купить 9 ударов", callback_data="buyls9"),
        ],
        [
            InlineKeyboardButton(
                text="⏪ Назад", callback_data="games")
...
def pen_rarities_kb(rarities):
    ...
    for rarity in rarities:
        btns.append([InlineKeyboardButton(
            text=rarity, callback_data=f"penrar_{rarity}")])
...
dice_btn = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="🎲 Удачный бросок", callback_data="dice"),
        ],
        [
            InlineKeyboardButton(
                text="⏪ Назад", callback_data="games")
...
darts_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(
                text="💰 Купить броски", callback_data="buydarts"),
        ],
        [
            InlineKeyboardButton(
                text="⏪ Назад", callback_data="games")
...
no_free_darts_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="💰 3 броска - 150 руб", callback_data="buydts3"),
        ],
        [
            InlineKeyboardButton(
...
casino_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(
                text="🎰 Крутить казино", callback_data="hitcasino"),
        ],
        [
            InlineKeyboardButton(
                text="💰 Купить попытки", callback_data="buycasino"),
        ],
        [
            InlineKeyboardButton(
                text="⏪ Назад", callback_data="games")
